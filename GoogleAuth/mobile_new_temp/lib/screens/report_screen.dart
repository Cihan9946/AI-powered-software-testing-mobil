...
class _ReportScreenState extends State<ReportScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.banditResults.isEmpty)
                      const Text('Bandit analiz sonucu bulunamadı.')
                    else
                      _buildResultsList(widget.banditResults),
                  ],
                ),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.aiResults.isEmpty)
                      const Text('AI analiz sonucu bulunamadı.')
                    else
                      _buildResultsList(widget.aiResults),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildResultsList(Map<String, dynamic> results) {
